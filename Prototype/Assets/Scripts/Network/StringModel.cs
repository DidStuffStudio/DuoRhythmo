...
public partial class StringModel {
    ...
    [RealtimeProperty(3, true, true)] private string _timer;
    [RealtimeProperty(4, true, true)] private string _newPlayerConnected;
    [RealtimeProperty(5, true, true)] private string _newPlayerUpdateTime;
    [RealtimeProperty(6, true, true)] private string _drumNodesSingle;
    [RealtimeProperty(7, true, true)] private string _drumNodesALL;
    [RealtimeProperty(8, true, true)] private string _animatorTime;
    [RealtimeProperty(9, true, true)] private string _effectsValues;
}
...
public partial class StringModel : RealtimeModel {
    ...
    public string timer {
        get {
            return _cache.LookForValueInCache(_timer, entry => entry.timerSet, entry => entry.timer);
        }
        set {
            if (this.timer == value) return;
            _cache.UpdateLocalCache(entry => { entry.timerSet = true; entry.timer = value; return entry; });
            InvalidateReliableLength();
    ...
    public string newPlayerUpdateTime {
        get {
            return _cache.LookForValueInCache(_newPlayerUpdateTime, entry => entry.newPlayerUpdateTimeSet, entry => entry.newPlayerUpdateTime);
        }
        set {
            if (this.newPlayerUpdateTime == value) return;
            _cache.UpdateLocalCache(entry => { entry.newPlayerUpdateTimeSet = true; entry.newPlayerUpdateTime = value; return entry; });
            InvalidateReliableLength();
            FireNewPlayerUpdateTimeDidChange(value);
        }
    }
    ...
    public string animatorTime {
        ...
        set {
            ...
            InvalidateReliableLength();
            FireAnimatorTimeDidChange(value);
        }
    }
    ...
    public event PropertyChangedHandler<string> timerDidChange;
    public event PropertyChangedHandler<string> newPlayerConnectedDidChange;
    public event PropertyChangedHandler<string> newPlayerUpdateTimeDidChange;
    ...
    public event PropertyChangedHandler<string> animatorTimeDidChange;
    ...
    private void FireTimerDidChange(string value) {
        try {
    ...
    private void FireNewPlayerUpdateTimeDidChange(string value) {
        try {
            newPlayerUpdateTimeDidChange?.Invoke(this, value);
        } catch (System.Exception exception) {
            UnityEngine.Debug.LogException(exception);
        }
    }
    ...
    private void FireAnimatorTimeDidChange(string value) {
        try {
            animatorTimeDidChange?.Invoke(this, value);
        } catch (System.Exception exception) {
            UnityEngine.Debug.LogException(exception);
        }
    }
    ...
    protected override int WriteLength(StreamContext context) {
        ...
        if (context.fullModel) {
            ...
            length += WriteStream.WriteStringLength((uint)PropertyID.Timer, _timer);
            length += WriteStream.WriteStringLength((uint)PropertyID.NewPlayerConnected, _newPlayerConnected);
            length += WriteStream.WriteStringLength((uint)PropertyID.NewPlayerUpdateTime, _newPlayerUpdateTime);
            ...
            length += WriteStream.WriteStringLength((uint)PropertyID.AnimatorTime, _animatorTime);
    ...
    protected override void Write(WriteStream stream, StreamContext context) {
        ...
        if (context.fullModel) {
            ...
            stream.WriteString((uint)PropertyID.Timer, _timer);
            stream.WriteString((uint)PropertyID.NewPlayerConnected, _newPlayerConnected);
            stream.WriteString((uint)PropertyID.NewPlayerUpdateTime, _newPlayerUpdateTime);
            ...
            stream.WriteString((uint)PropertyID.AnimatorTime, _animatorTime);
        ...
        while (stream.ReadNextPropertyID(out uint propertyID)) {
            switch (propertyID) {
                ...
                case (uint)PropertyID.Timer: {
                    string previousValue = _timer;
                    _timer = stream.ReadString();
                    bool timerExistsInChangeCache = _cache.ValueExistsInCache(entry => entry.timerSet);
                    if (!timerExistsInChangeCache && _timer != previousValue) {
                        FireTimerDidChange(_timer);
                    }
                    break;
                }
                ...
                case (uint)PropertyID.NewPlayerUpdateTime: {
                    string previousValue = _newPlayerUpdateTime;
                    _newPlayerUpdateTime = stream.ReadString();
                    bool newPlayerUpdateTimeExistsInChangeCache = _cache.ValueExistsInCache(entry => entry.newPlayerUpdateTimeSet);
                    if (!newPlayerUpdateTimeExistsInChangeCache && _newPlayerUpdateTime != previousValue) {
                        FireNewPlayerUpdateTimeDidChange(_newPlayerUpdateTime);
                    }
                    break;
                }
                ...
                case (uint)PropertyID.AnimatorTime: {
                    string previousValue = _animatorTime;
                    _animatorTime = stream.ReadString();
                    bool animatorTimeExistsInChangeCache = _cache.ValueExistsInCache(entry => entry.animatorTimeSet);
                    if (!animatorTimeExistsInChangeCache && _animatorTime != previousValue) {
                        FireAnimatorTimeDidChange(_animatorTime);
                    }
                    break;
                }
    ...
    private void FlattenCache() {
        ...
        _newPlayerUpdateTime = newPlayerUpdateTime;
