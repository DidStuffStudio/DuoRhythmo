Shader "Normal/Examples/Hoverbird Beak" {
	Properties {
	...
	SubShader {
		...
		void surf(Input i , inout SurfaceOutputStandard o) {
			...
			o.Albedo = SAMPLE_TEXTURE2D(_GradientTexture, sampler_GradientTexture, (appendResult275*_GradientScale + mulTime283).xy).rgb;
			o.Alpha = 1;
		}
